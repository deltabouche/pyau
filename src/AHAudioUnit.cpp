...
void AHAudioUnit::LoadAUPresetFromFile(string aupresetPath)
{
    ...
    // dump the au preset file out as a sanity check
    /*
     ...
     <key>name</key>
     <string>alicia</string>
     <key>subtype</key>
     <integer>1315524405</integer>
     <key>type</key>
     ...
     <data>
     */
    PrintCFStringRef(CFStringCreateFromExternalRepresentation(kCFAllocatorDefault, xmlData, kCFStringEncodingUTF8));
